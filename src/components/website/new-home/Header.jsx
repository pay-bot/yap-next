...
function Header({ className, isShop }) {
  ...
  return (
    <div
      className={
        className ||
        "max-w-screen-lg 2xl:max-w-screen-xl mx-auto flex justify-between h-20 absolute inset-x-0 z-30 md:px-0 px-4 "
      }
    >
      <img
      ...
      <div className="flex items-center">
        ...
        {isLogin.adminToken ? (
            ...
            <ul className="dropdown-menu absolute hidden text-gray-700 pt-1">
              ...
              <li className="">
                <button
                  ...
                  className="bg-gray-200 rounded-b hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap"
                >
                  Logout
                </button>
              </li>
          ...
          <div className="text-white flex pl-2">
            ...
            <Link
              to="/login"
              className="border border-blue-500 rounded py-1 px-3"
            >
              Login
            </Link>
          </div>

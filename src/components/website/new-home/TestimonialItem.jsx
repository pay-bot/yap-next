...
function TestimonialItem({ rating, testimonial, userImg, name, designation }) {
  const ratings = [];
  for (let i = 0; i < 5; i++) ratings.push(i < rating ? <StarIcon key={i} /> : <StarIconOutlined key={i} />);
      ...
      <div className="px-7 pt-7 pb-6">
        ...
        <div>
          <div className="mt-4 flex items-center">
            <img className=" w-14 h-14 border border-[#BDBDBD] bg-black rounded-full object-cover" src={userImg} alt="" />

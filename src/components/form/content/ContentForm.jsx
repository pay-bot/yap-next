...
function ContentForm({ defaultValues, onFormSubmit }) {
  ...
  const removeMedia = async () => {
    return axios
      .delete(
        `${process.env.REACT_APP_API_URL}/pages/${pageId}/sections/${sectionId}/content/${contentId}/removeMedia`,
        {}
      )
                    ...
                    <div className=" w-full">
                      {defaultValues?.media && (
                        <div className="  border">
                          ...
                          <img
                            src={`https://yap-admin.herokuapp.com/uploads/images/${defaultValues?.media}`}
                            alt=""
                      ...
                      <QuillWrapper
                        value={
                          defaultValues?.content_in
                            ? editorContent_in ||
                              defaultValues?.content_in?.content_in
                            : editorContent_in || ""
                        }
                        onChange={onEditorStateChange}
                      />

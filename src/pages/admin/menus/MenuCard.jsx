        ...
        >
          <div key={route.id} className="flex items-center py-1">
            ...
            <div className="ml-auto flex justify-end gap-x-1">
              {/* <Icon>menu</Icon> */}
              <Menu
                tooltip={`Add Children ${route.name}`}
                onClick={() =>
                  dispatch(
              ...
              <div className="realative">
                ...
                {anchorEl.isParent && anchorEl.id === route.id && (
                  <div className="">
                    <div className="absolute -translate-x-[50%] p-1 border-2 border-red-600 bg-red-300 rounded-md">

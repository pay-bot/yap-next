...
export default function Media() {
  ...
  media?.data?.data?.map((data) => {
    if (data.photoable_id.toString() === resCategoryId.toString() && data.photoable_type === 'App\\Models\\ResourceCategory') {
  ...
  return (
    <SectionWrapper>
      <ContentHeading title="Media List">
        <button type="button" onClick={() => dispatch(openModal({ componentName: 'AttachMediaResourceCategory', id: '' }))}>
          Attach Media
        </button>

        <ModalWrapper componentName="AttachMediaResourceCategory" modalid="">
          <AttachMediaForm dataMedia={dataMedias} photoable_id={resCategoryId} photoable_type="App\Models\ResourceCategory" httpPost="/resources/photos/attach" />
        </ModalWrapper>
      </ContentHeading>

      <AddMediaWrapper httpPost="resources/photos/upload" photoable_id={resCategoryId} photoable_type_name="ResourceCategory" photoable_type="App\Models\ResourceCategory" />

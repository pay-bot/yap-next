...
// import { fetchArticleData } from '../../../../hooks/useArticlesData';
...
//       formData.append('key', '');
//       formData.append('photoable_id', resCategoryId);
//       formData.append('photoable_type_name', 'ResourceCategory');
//       formData.append('photoable_type', `App\\Models\\ResourceCategory`);
//       request({
//         url: `${process.env.REACT_APP_API_URL}/resources/photos/upload`,
//         method: 'post',
//         data: formData,
...
//   const { data: article } = useQuery(['article', { resCategoryId }], fetchArticleData);
...
//     if ((data.photoable_id == resCategoryId) & (data.photoable_type === 'App\\Models\\ResourceCategory')) {
...
//   return (
//     <SectionWrapper>
//       <TitlePage title="Media" description={`Add media for ${article?.article?.name}`} />
//       <ContentHeading>
